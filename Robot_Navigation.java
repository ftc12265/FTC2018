...
public class Robot_Navigation
{
    ...
    public void initVuforia(LinearOpMode opMode, Robot_OmniDrive robot) {
        ...
        // and paste it here...
        parameters.vuforiaLicenseKey = "";
        ...
        targets.get(0).setName("Blue Aliance");
        targets.get(1).setName("Red Aliance");
        targets.get(2).setName("Front Wall");
        targets.get(3).setName("Back Wall");
        ...
        final int CAMERA_FORWARD_DISPLACEMENT  = 210;   // Camera is 110 mm in front of robot center
